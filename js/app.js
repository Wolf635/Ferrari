(() => {
    ...
    function initSliders() {
        if (document.querySelector(".our-services__slider")) new swiper_core_Swiper(".our-services__slider", {
            ...
            lazy: true,
            navigation: {
                prevEl: ".our-services__arrow-prev.swiper-button-prev",
                nextEl: ".our-services__arrow-next.swiper-button-next"
            },
            breakpoints: {
                320: {
                    slidesPerView: 1,
        ...
        if (document.querySelector(".models__slider")) new swiper_core_Swiper(".models__slider", {
            modules: [ Navigation ],
            observer: true,
            observeParents: true,
            spaceBetween: 20,
            ...
            lazy: true,
            navigation: {
                prevEl: ".models__arrow-prev",
                nextEl: ".models__arrow-next"
            },
            breakpoints: {
                320: {
                    slidesPerView: 2,
